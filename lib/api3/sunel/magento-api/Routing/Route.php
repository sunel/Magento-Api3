...
class Route
{
     ...
     * @return void
     */
    public function __construct(Container $container, Request $request, $route)
    {
        $this->container = $container;

        list($this->uri, $this->methods, $this->action) = $this->getRouteProperties($route, $request);
